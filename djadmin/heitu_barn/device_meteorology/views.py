...
from .serializers import MeteorologySerializer
...
class DataList(generics.ListCreateAPIView):
    queryset = Meteorology.objects.all()
    serializer_class = MeteorologySerializer
...
def DataDetailView(request, dataid):
    ...
    data = get_object_or_404(Meteorology, pk=dataid)
