...
class barndeviceadmin(LeafletGeoAdmin,ImportExportModelAdmin):
    resource_class = BarndeviceResource
    # 控制哪些字段会显示在Admin 的修改列表页面中
    list_display = (
        "name","deviceid","lat", "lon", "create_time","update_time",)
    ...
    #     super().save_model(request, obj, form, change)
# 注册app的admin
admin.site.register(Barndevice, barndeviceadmin)
