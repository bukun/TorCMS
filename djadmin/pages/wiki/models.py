...
class TheWiki(basemodel):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, blank=True,
                             null=True, related_name='wiki', editable=False, verbose_name='作者')
    sites = models.ManyToManyField(Site, blank=True, related_name='wiki', verbose_name='Site')
