...
class PlanarFeaturesAdmin(LeafletGeoAdmin, ImportExportModelAdmin):
    resource_class = ApiAppResource
    # 控制哪些字段会显示在Admin 的修改列表页面中
    list_display = ("id","region","location_name", "historical_name", "set_time", "cancel_time","content","zoom")
    # 用来排序
...
# 注册app的admin
admin.site.register(PlanarFeatures, PlanarFeaturesAdmin)
