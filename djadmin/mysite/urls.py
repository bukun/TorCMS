...
from black_html.sphinx_doc.views import sphinx_docs, sphinx_document_list
...
urlpatterns = (
    ...
    path(
        'device_soilmoisture/', include('heitu_barn.device_soilmoisture.urls')
    ),  # 黑土粮仓农业气象站数据
    path(
        'device_soilfiveparameters/',
        include('heitu_barn.device_soilfiveparameters.urls'),
    ),  # 黑土粮仓农业气象站数据
    path(
        'device_soilfiveparametersv2/',
        include('heitu_barn.device_soilfiveparametersv2.urls'),
    ),  # 黑土粮仓农业气象站数据
    path(
        'device_meteorology/', include('heitu_barn.device_meteorology.urls')
    ),  # 黑土粮仓农业气象站数据
    ...
    path(
        'literature_category/', include('literature.literature_category.urls')
    ),  # 文献分类管理
    ...
    path(
        'Basic_Geographic_Element_Category/',
        include('yaou_data_categorys.Basic_Geographic_Element.urls'),
    ),  # 亚欧大陆分类表
