...
from dresource.resource_label.models import ResourceLabel
...
class Resource(basemodel):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, null=True, related_name='resource', editable=False,
                             verbose_name='用户名')
