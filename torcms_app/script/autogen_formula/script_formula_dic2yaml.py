...
f100 = {
    ...
    'res': ['la1:自由空间处声功率级',
            'la2: 半自由空间处声功率级'],
    'py': ['lwa - 20 * Math.log(r, 10) - 11',
           'lwa - 20 * Math.log(r, 10) - 8'],
}
a900 = {
...
a124 = {'keywords': '环评,理论空气需要量,计算', 'desc': '理论空气需要量（VO）的计算 ', 'title': '理论空气需要量（VO）的计算 ', 'p': ['QL:燃料应用基低位发热值'],
        'res': ['VO:燃料燃烧所需理论空气量 '], 'js': ['0.251*QL/1000+0.278'], 'py': ['0.251*QL/1000+0.278']}

a125 = {'keywords': '环评,理论空气需要量,计算', 'desc': '理论空气需要量（VO）的计算_模型一', 'title': '理论空气需要量（VO）的计算_模型一',
        'p': ['QL:燃料应用基低位发热值'],
        'res': ['VO:燃料燃烧所需理论空气量 '], 'js': ['QL/4140+0.606'], 'py': ['QL/4140+0.606']}
a107 = {'keywords': '葡萄酒生产,耗水量', 'desc': '耗水量 ', 'title': '生产葡萄酒耗水量 ', 'p': ['Qt:葡萄酒生产年耗新鲜水量', 'Yw: 葡萄酒的年产量'],
        'res': ['Q:生产每KL葡萄酒的耗水量 '], 'js': ['Qt/Yw'], 'py': ['Qt/Yw']}
f005 = {'keywords': '理论空气,需要量', 'desc': '理论空气需要量（VO）的计算_模型二', 'title': '理论空气需要量（VO）的计算_模型二', 'p': ['QL:燃料应用基低位发热值'],
        'res': ['VO:燃料燃烧所需理论空气量 '], 'js': ['0.203*QL/1000+2'], 'py': ['0.203*QL/1000+2']}
a128 = {'keywords': '环评,水泥立窑,废气量',
        'desc': '水泥立窑废气量的估算 ',
        'title': '水泥立窑废气量的估算 ',
        'p': ['M:立窑熟料全年产量', 'Qa:单位熟料的废气生成量', 'K1:生产不均匀系数', 'K2:漏风系数'],
        'res': ['Q年:立窑排放的年废气量 '], 'js': ['M*Qa*K1*K26'],
        'py': ['M*Qa*K1*K2']}

a108 = {'keywords': '葡萄酒生产,耗电量', 'desc': '耗电量 ', 'title': '葡萄酒生产年耗电量 ', 'p': ['Wt:葡萄酒生产年耗电量', 'Yw: 葡萄酒的年产量'],
        'res': ['W:生产每KL葡萄酒的耗电量 '], 'js': ['Wt/Yw'], 'py': ['Wt/Yw']}
a105 = {'keywords': '葡萄酒生产,出汁率', 'desc': '出汁率 ', 'title': '葡萄生产出汁率 ', 'p': ['Wj: 年葡萄汁总量', 'Wr: 葡萄原料总消耗量'],
        'res': ['Rj:出汁率 '], 'js': ['Wj/Wr*100'], 'py': ['Wj/Wr*100']}
a106 = {'keywords': '葡萄酒生产,出酒率', 'desc': '出酒率 ', 'title': '葡萄生产出酒率 ',
        'p': ['Yq:年葡萄酒合格品量', 'G: 20摄氏度时葡萄酒的密度', 'Wr: 葡萄原料年总消耗量'], 'res': ['Rw:出酒率 '], 'js': ['Yq*G/Wr*100'],
        'py': ['Yq*G/Wr*100']}

a121 = {'keywords': '冷却水循环,利用率', 'desc': '冷却水循环利用率 ', 'title': '冷却水循环利用率 ',
        'p': ['Rp:冷却水重复利用量', 'Qr:重复利用水量', 'Qf: 冷却水用新水量'], 'res': ['Ru:冷却水循环利用率 '], 'js': ['Rp/(Qf+Qr)*100'],
        'py': ['Rp/(Qf+Qr)*100']}
a120 = {'keywords': '葡萄酒生产,皮渣及发酵渣产生量', 'desc': '皮渣及发酵渣产生量 ', 'title': '皮渣及发酵渣产生量 ',
        'p': ['P:葡萄酒生产中产生的湿皮渣和发酵皮渣', 'Yw: 葡萄酒的年产量'], 'res': ['Cp:生产每KL葡萄酒皮渣及发酵渣产生量 '], 'js': ['P/Yw'], 'py': ['P/Yw']}
a109 = {'keywords': '葡萄酒生产,综合能耗', 'desc': '综合能耗 ', 'title': '生产每KL葡萄酒的综合能耗', 'p': ['Ej:葡萄酒生产年综合能耗', 'Yw: 葡萄酒的年产量'],
        'res': ['E:生产每KL葡萄酒的综合能耗 '], 'js': ['Ej/Yw'], 'py': ['Ej/Yw']}
a126 = {'keywords': '环评,烟气量计算', 'desc': '实际烟气量的计算 ', 'title': '实际烟气量的计算 ',
        'p': ['Alpha:过剩空气系数', 'VO:燃料燃烧所需理论空气量', 'QL:燃料应用基低位发热值'], 'res': ['Qy:实际烟气量 '],
        'js': ['1.04*QL/4187+0.77+1.0161*(Alpha-1)*VO'], 'py': ['1.04*QL/4187+0.77+1.0161*(Alpha-1)*VO']}

a130 = {'keywords': '环评,固定顶罐,工作排放', 'desc': '工作排放 ', 'title': '固定顶罐的工作排放 ',
        'p': ['M:储罐内蒸汽的分子量', 'P:在大量液体状态下，真实的蒸汽压力', 'KN:周转因子', 'KC:产品因子'], 'res': ['LW:固定顶罐的工作损失 '],
        'js': ['4.188*Math.pow(10,-7)*M*P*KN*KC'],
        'py': ['4.188*Math.pow(10,-7)*M*P*KN*KC']}
a104 = {'keywords': '环评,锅炉,烟尘', 'desc': '锅炉烟尘计算', 'title': '锅炉烟尘计算',
        'p': ['G: 耗煤量', 'A: 煤中灰分', 'EtaA: 煤中飞灰占灰分的百分比。', 'Eta: 除尘效率'], 'res': ['Q:锅炉烟尘'], 'js': ['G*A*EtaA*(1-Eta)'],
        'py': ['G*A*EtaA*(1-Eta)']}

a102 = {'py': ['M*(0.000352+0.000786*V)*P*F'], 'title': '液体（除水以外）蒸发量', 'desc': '液体（除水以外）蒸发量',
        'p': ['A: 煤的灰分，％', 'M: 液体分子量 ', 'V:蒸发液体表面上的空气流速（米/秒），以实测数据为准，无条件实测，一般可取0.2-0.5）',
              'P:相应于液体温度下的空气中的蒸汽分压力（毫米汞柱），当液体浓度低于10%时，用水溶液的饱和蒸汽压代替；当液体重量浓度高于10%', 'F: 液体蒸发面的表面积'],
        'keywords': '环评,液体,蒸发量', 'js': ['M*(0.000352+0.000786*V)*P*F'], 'res': ['GZ:千克/时']}
a834 = {'py': ['1.6*B*S'], 'title': '锅炉燃煤烟气烟尘和SO2', 'desc': '锅炉燃煤烟气烟尘和SO2', 'p': ['S: 煤中的全硫份含量，％', 'B: 燃煤量，㎏'],
        'keywords': '环评,锅炉燃煤,烟气烟尘', 'js': ['1.6*B*S'], 'res': ['Gso2:SO2产生量，㎏']}

a89a = {'py': ['P*0.81*S*(V/30)*((365-W)/365)*(T/4)'],
        'title': '建设工地起尘量计算',
        'desc': '建设工地起尘量计算',
        'p': ['V: 平均车速，km/h',
...
a111 = {'py': ['B*A*dfh/(1-Cfh)'],
        ...
        'p': ['A: 煤的灰分，％',
              ...
              'Cfh:烟尘中可燃物的百分含量，％'],
        'keywords': '环评,烟尘,产生量',
        'js': ['B*A*dfh/(1-Cfh)'], 'res': ['Gsd:烟尘产生量，㎏']}
aa4c = {'py': ['0.000501 * V * 0.823 * U * 0.139 * T / 4'], 'title': '道路起尘量计算', 'desc': '道路起尘量计算',
        'p': ['V: 车辆', 'U: —起尘风速，一般取5m/s', 'T: —每辆车的平均轮胎数，一般取6'], 'keywords': '环评,道路,起尘量',
        'js': ['0.000501 * V * 0.823 * U * 0.139 * T / 4'], 'res': ['E:单辆车引起的道路起尘量散发因子，kg/km']}

ac8d = {'py': ['0.05*(pV/1.5)*(pd/90)*(pd/255)*(pf/15)'],
        'title': '车辆行驶导致的煤堆起尘量计算',
        'desc': '车辆行驶导致的煤堆起尘量计算',
        'p': ['pV:车辆驶过煤堆的平均车速，km/h',
              'pd:每年干燥天数，d',
              'pf:风速超过19.2km/h的百分数。'],
        'keywords': '环评,煤堆,起尘量',
...
f002 = {'py': ['11.7* Math.pow(U,2.45)* Math.pow(S,0.345)*Math.pow(Math.e,-0.5*V)*Math.pow(Math.e,-0.55*(w-0.07))'],
        'title': '环评_煤堆起尘量计算', 'desc': '煤堆起尘量计算',
        'p': ['U: 临界风速，m/s，取大于5.5m/s', 'S: 煤堆表面积，m2', 'V: 空气相对湿度，取60%', 'w:煤物料湿度，原煤6%。'], 'keywords': '环评,煤堆,起尘量',
        'js': ['11.7*Math.pow(U, 2.45)*Math.pow(S,0.345)*Math.pow(e,-0.5*ω)*Math.pow(e,-0.55*(w-0.07))'],
        'res': ['Qm:煤堆起尘量，mg/s']}

a129 = {'keywords': '环评,固定顶罐,呼吸排放', 'desc': '呼吸排放 ', 'title': '固定顶罐的呼吸排放 ',
        'p': ['M:储罐内蒸汽的分子量', 'P:在大量液体状态下，真实的蒸汽压力', 'D:罐的直径', 'H:平均蒸汽空间高度', 'DeltaT:一天之内的平均温差', 'FP:涂层因子（无量纲）',
              'C:用于小直径罐的调节因子（无量纲）', 'KC:产品因子'], 'res': ['LB:固定顶罐的呼吸排放量 '],
        'js': ['0.191*M*Math.pow((P/(100910-P)),0.68)*D*1.73*H*0.51*Math.pow(DeltaT,0.45)*FP*C*KC'],
        'py': ['0.191*M*Math.pow((P/(100910-P)),0.68)*D*1.73*H*0.51*Math.pow(DeltaT,0.45)*FP*C*KC']}
a123 = {'keywords': '工业废气,实测法,排放总量',
        'desc': '实测法 ',
        'title': '工业废气排放总量计算实测法 ',
        'p': ['Q:废气小时排放量', 'By:全年燃料耗量（或熟料产量）', 'bh: 在正常工况下每小时的燃料耗量（或熟料产量）'],
        'res': ['res1:全年废气排放量 '],
        'js': ['Q*B/b/10000'], 'py': ['Q*By/bh/10000']}
a127 = {'keywords': '环评,烟气总量,计算', 'desc': '烟气总量的计算 ', 'title': '烟气总量的计算 ', 'p': ['B:燃料耗量', 'Qy:实际烟气量'],
        'res': ['Q总:烟气总量 '], 'js': ['B*Qy'], 'py': ['B*Qy']}

a131 = {'keywords': '环评,固体废物,锅炉', 'desc': '固体废物的计算 ', 'title': '固体废物的计算 ',
        'p': ['B:锅炉燃煤量', 'A:燃煤的应用基灰分', 'Eta:除尘效率', 'CZ:炉渣中可燃物百分含量', 'Cf:煤灰中可燃物的百分含量', 'dz:炉渣中的灰分占燃煤总灰分的百分比',
...
a103 = {'keywords': '环评,锅炉,烟气', 'desc': '锅炉烟气计算', 'title': '锅炉烟气计算',
        'p': ['G: 耗煤量', 'S: 煤中含硫量', 'Etaso2: 脱硫效率，麻石水浴、水膜按40%计，石灰石-石膏法按90%计。'], 'res': ['Q:锅炉烟气'],
        'js': ['G*2*0.8*S*(1-Etaso2)'], 'py': ['G*2*0.8*S*(1-Etaso2)']}

a110 = {'keywords': '葡萄酒生产,废水产生量',
        'desc': '废水产生量 ',
...
f003 = {'py': ['2.1*K*Math.pow((U-U0),3)*Math.pow(Math.e,(-1.023*W))*p'],
        'title': '秦皇岛码头煤堆起尘量计算', 'desc': '秦皇岛码头煤堆起尘量计算',
        'p': ['K: 经验系数，是煤含水量的函数，取K=0.96', 'U: 煤场平均风速，m/s', 'U0: 煤尘的启动风速，m/s，取3.0m/s', 'W:煤尘表面含水率，%', 'p:煤场年累计堆煤量，t/a'],
        'keywords': '环评,码头,煤堆起尘量', 'js': ['2.1*k*Math.pow((U-u0),3)*Math.pow(e,(-1.023*w))*p'],
        'res': ['Qp:煤堆起尘量，kg/a']}
#
f053 = {'py': ['C * 24  * (D-d) * P * (l - Ac) * E * Math.pow(10,-6)',
               'QA*l'],
        'title': '一年中单位长度道路的起尘量计算', 'desc': '一年中单位长度道路的起尘量计算',
        'p': ['C: 每小时平均车流量，辆/h', 'D: 计算的总天数，365天', 'd: 一年中降水量大于0.254mm的天数', 'P: 道路级别系数，如内环线以内可取0.4，内外环线之间取0.8',
              'Ac: 消尘系数，如内环线以内可取0.4，内外环线之间取0.2', 'l: 道路长度，km', 'E: 单辆车引起的道路起尘量散发因子'], 'keywords': '环评,道路,起尘量',
        'js': ['C * 24  * (D-d) * P * (l - Ac) * E * 10^(-6)', 'C * 24  * (D-d) * P * (l - Ac) * E * 10^(-6)*l'],
...
#
#
f058 = {'keywords': '污染物,排放总量,最高', 'desc': '某污染物最高允许排放总量', 'title': '某污染物最高允许排放总量',
...
# 环评公式_83v.doc
f017 = {'keywords': '临界氧亏模型,在线计算', 'desc': '临界氧亏模型在线计算', 'title': '临界氧亏模型在线计算',
        'p': ['kd:有机物降解常数,d',
              'ka:大气富氧常数,d',
              't:时间,s',
              'Os:水中饱和溶解氧浓度,mg/L',
        ...
        'py': ['L0* Math.exp(-kd*t)', 'Os-(kd*L0)/(ka-kd)*( Math.exp(-kd*t)-Math.exp(-ka*t))-Do*Math.exp(-ka*t)']}
#
f043 = {'keywords': '卫生,排放,防护距离', 'desc': '无组织排放卫生防护距离 ', 'title': '无组织排放卫生防护距离 ',
        'p': ['cm:标准浓度限值', 'L:工业企业所需卫生防护距离', 'r:有害气体无组织排放源所在生产单位的等效半径', 'S:该生产单元占地面积',
              'A:卫生防护距离计算系数',
              'B:卫生防护距离计算系数',
              'C:卫生防护距离计算系数',
              'D:卫生防护距离计算系数',
...
f035 = {'keywords': '无限长,线声源,几何发散,衰减',
        ...
        'res': ['A:无限长线声源的几何发散衰减',
                'LR: 预测点的声级'],
        'py': ['10* Math.log(r/r0, 10)',
               '(lr0 - A) if (lr0 - A) > 0 else 0'],
        'js': ['10* Math.log(r/r0) '],
        }
...
f041 = {'keywords': '地面浓度', 'desc': '地面浓度 ', 'title': '地面浓度 ',
        'p': ['Q:单位时间排放量', 'U:排气筒出口处的平均风速', 'He:排气筒有效高度', 'X:距排气筒下风向水平距离', 'a1:横向扩散参数回归指数', 'a2:铅直扩散参数回归指数',
              'y1:横向扩散参数回归系数', 'y2:铅直扩散参数回归系数'],
...
# 环评公式_83v.doc
f019 = {'keywords': '昼夜,等效声效,在线计算',
        'desc': '昼夜等效声级在线计算',
        'title': '昼夜等效声级在线计算',
        'p': ['Ld:白天的等效A声级', 'Ln:夜间的等效A声级', ],
        'res': ['Ldn:昼夜等效声级'],
        # 'js': ['10* Math.log(16*Math.pow(10,0.1*Ld+8*Math.pow(10,0.1*(Ln+10)))/24, 10)'],
        'py': ['10* Math.log((16* Math.pow(10,0.1*Ld) +8* Math.pow(10,0.1*(Ln+10)))/24, 10)']}
#
...
f020 = {'keywords': '大气,污染,指数', 'desc': '大气污染指数 ', 'title': '大气污染指数 ', 'p': ['Ci:污染物检测值', 'Coi:质量标准限值'],
        'res': ['Ii:污染物质量指数 '], 'js': ['Ci/Coi'], 'py': ['Ci/Coi']}
f057 = {'keywords': '工业污水,排放负荷,污染物', 'desc': '工业污水污染物最高允许排放负荷计算 ', 'title': '工业污水污染物最高允许排放负荷计算 ',
...
f056 = {'keywords': '河流,混合模式', 'desc': '河流完全混合模式 ', 'title': '河流完全混合模式 ',
        'p': ['cp:污染物排放浓度', 'ch:河流上游污染物浓度', 'Qp:废水排放量', 'Qh:河流流量'], 'res': ['c:污染物浓度 '],
        'js': ['(cp*Qp+ch*Qh)/(Qp+Qh)'], 'py': ['(cp*Qp+ch*Qh)/(Qp+Qh)']}
f055 = {'keywords': '河流,一维,稳态', 'desc': '河流一维稳态模式 ', 'title': '河流一维稳态模式 ',
        'p': ['c0:计算初始点污染物浓度', 'K1:耗氧系数', 'K3:沉降系数', 'u:河流流速', 'x:从计算初始点到下游计算断面的距离'], 'res': ['c:计算断面污染物浓度 '],
        'js': ['c0*Math.exp(-(K1+K3)*(x/(86400*u)))'],
        'py': ['c0*Math.exp(-(K1+K3)*(x/(86400*u)))']}
f040 = {'keywords': '等标排放量', 'desc': '等标排放量 ', 'title': '等标排放量 ', 'p': ['Qi:污染物检测值', 'Coi:第i类污染物环境空气质量标准'],
...
e007 = {
    ...
    'py': ['Math.PI*r*(h1+h2)+Math.PI+ r * r *(1+(1/ Math.cos(a)))',
           'Math.PI*r*(h1+h2)',
           'Math.PI*r * r*((h1+h2)/2)',
           ],
}
...
e013 = {
    ...
    'py': ['(Math.pow(Math.PI,2)*p*Math.pow(j,2))/4',
...
e015 = {
    ...
    'res': ['res1:抛物线形桶体积',
            'res2:圆形桶体积', ],
    'py': ['Math.PI*(l/15)*(2*D* D +D*d+(3/4)* d * d)',
...
e016 = {
    ...
    'res': ['res1:椭球体表面积',
            'res2:椭球体体积', ],
    'py': ['2* Math.pow(2, (1/2)) *b*  Math.pow((a* a +b* b ), (1/2))',
           'Math.PI*(4/3)*a*b*c',
           ],
}
...
e026 = {
    ...
    'py': ['Math.pow((b* b +1.3333*h* h ), (1/2))',
           '(4/3)*h',
           ],
}
...
e036 = {
    ...
    'py': ['Math.sqrt((l*l /n* n )-(Math.PI* Math.PI * d * d))',
...
e061 = {
    ...
    'py': ['(a+b+a1+b1)*H+Math.PI*2*r*(a2+b2)/5',
           ],
}
...
e063 = {
    ...
    'desc': '矩形四边形放坡地坑计算',
    'p': ['A:包括边宽工作面在内的坑底双向开挖尺寸', 'B:包括边宽工作面在内的坑底双向开挖尺寸',
          'H:地坑开挖深度',

          'K:放坡坡度系数',

          ],
    'res': ['res1:矩形四边形放坡地坑体积',
            ],
    'py': ['(A+K*H)*(B+K)*H+K* K *H* H * H/3',
           ],
}
...
e065 = {
    ...
    'py': ['(A+K*H)*(B+K)*H-K*H* H *(3*B+2*K*H)/6',
           ],
}
...
e066 = {
    ...
    'res': ['res1:矩形相邻两边放坡、二边挡土板地坑体积',
            ],
    'py': ['(A+K*H)*(B+K)*H-K*H* H *(3*A+3*B+4*K*H)/6',
           ],
}
...
e070 = {
    ...
    'p': ['A:包括边宽工作面在内的坑底双向开挖尺寸',
          'H:地坑开挖深度',
          'L:长度',
          'K:放坡坡度系数',

          ],
    'res': ['res1:挖地槽、无工作面、单边放坡挡土坡体积',
            ],
    'py': ['L*(A+K*H/2)*H',
           ],
}
...
if __name__ == '__main__':
    ...
    for key in all_app.keys():
        if len(key) == 4:
            ...
            # print(yaml.dump(app, ))
            with open(
                    'out/{title}_s{sig}.yaml'.format(
                        title=app['title'], sig=key), 'w'
            ) as fo:
                yaml.dump(
                    app, fo, default_flow_style=False,
