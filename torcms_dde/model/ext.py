...
class Records(BaseModel):
    ...
    operatesonidentifier = peewee.CharField(default='', help_text='operatesonidentifier')
    ...
    conditionapplyingtoaccessanduse = peewee.CharField(default='', help_text='conditionapplyingtoaccessanduse')
    lineage = peewee.CharField(default='', help_text='lineage')
    responsiblepartyrole = peewee.CharField(default='', help_text='responsiblepartyrole')
