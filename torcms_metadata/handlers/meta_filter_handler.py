    ...
    if pagination_num == 1 or pagination_num == 0:
        ...
        for num in range(cur_num, show_num):
            ...
            tmp_str_df = '''<li class="page-item {0}" name='fenye' onclick='change(this);'
              value='{1}'><a class="page-link">{1}</a></li>'''.format(checkstr, num)

            pager_mid += tmp_str_df
        if fenye_num < pagination_num:
            pager_next = '''<li class="page-item {0}" name='fenye' onclick='change(this);'
              value='{1}'><a class="page-link">Next Page</a></li>'''.format('', fenye_num + 1)
            pager_last = '''<li class="page-item {0}" name='fenye' onclick='change(this);'
              value='{1}'><a class="page-link">End Page</a></li>'''.format('', pagination_num)
...
class MetaFilterHandler(BaseHandler):
    '''
    ...
    def echo_html(self, url_str):
        ...
        if url_arr[1] == 'con':
            ...
            self.echo_html_list_str(sig, infos, kind)
        elif url_arr[1] == 'num':
    ...
    def echo_html_list_str(self, catid, infos, kind):
        '''
        ...
        self.render('../torcms_metadata/autogen/infolist/infolist.html',
    ...
    def list(self, catid):
        ...
        self.render('../torcms_metadata/autogen/list/list.html',
                    userinfo=self.userinfo,
                    kwd=kwd,
                    widget_info=kwd,
