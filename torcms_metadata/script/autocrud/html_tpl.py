...
TPL_ADD = '''
    {% extends "../torcms_metadata/tpl_add.html" %}
...
TPL_EDIT = '''
    {% extends "../torcms_metadata/tpl_edit.html" %}
...
TPL_LIST = '''
    {% extends "../torcms_metadata/tpl_list.html" %}
    {% block header %}
    {{ header_text }}
    {% end %}
    {% block infoselect %}
...
TPL_LISTINFO = '''{% extends "../torcms_metadata/tpl_listinfo.html" %}'''

TPL_VIEW = '''{% extends "../torcms_metadata/tpl_view.html" %}
    {% block header %}
    <h1>{{ header_text }}</h1>
    {% end %}
