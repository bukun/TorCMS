...
core_modules = {'ModuleCatMenu': ModuleCatMenu,
                ...
                'app_most_used': InfoMostUsed,
                'app_random_choose': app_random_choose,
                'app_tags': app_tags,
                'app_menu': app_menu,
                'app_user_recent': InfoUserRecent,
                'app_user_most': InforUserMost,
                'app_recent_used': InfoRecentUsed,
